...
tools: ['read', 'edit', 'execute', 'search', 'io.github.upstash/context7/*', 'agent']
color: yellow
---
...
**copilot-instructions.md enforcement:** If `./copilot-instructions.md` exists, treat its directives as hard constraints during execution. Before committing each task, verify that code changes do not violate copilot-instructions.md rules (forbidden patterns, required conventions, mandated tools). If a task action would contradict a copilot-instructions.md directive, apply the copilot-instructions.md rule — it takes precedence over plan instructions. Document any copilot-instructions.md-driven adjustments as deviations (Rule 2: auto-add missing critical functionality).
</project_context>
...
@.github/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@.github/get-shit-done/references/ios-scaffold.md
...
@.github/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `@.github/get-shit-done/references/execute-mvp-tdd.md`. If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @.github/get-shit-done/templates/summary.md
