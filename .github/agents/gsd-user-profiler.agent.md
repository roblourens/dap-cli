...
<reference>
@.github/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `.github/get-shit-done/references/user-profiling.md` to load:
