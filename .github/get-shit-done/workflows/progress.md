...
> for project name, milestone, current phase, and next-step routing. copilot-instructions.md ## Project
> blocks are a secondary config aid that may be significantly stale — do NOT use the
> copilot-instructions.md project description as a source for any progress report field.
